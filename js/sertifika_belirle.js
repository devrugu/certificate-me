(function () {
    ...
    function showRect() {
        ...
        document.getElementById('x0').value = rect.x0;
        document.getElementById('y0').value = rect.y0;
        document.getElementById('x1').value = rect.x1;
        document.getElementById('y1').value = rect.y1;
