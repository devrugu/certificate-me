...
<link rel="stylesheet" href="kurumekle.css?v=<?php echo time(); ?>">
    <main>
        ...
        <?php
            ...
            if (isset($_GET['error'])) {
                ...
                switch ($errorCheck) {
                    ...
                    case 'gecersizEpostaVeKullaniciAdi':
                        echo '<p class="error">Geçerli bir e-posta veya kullanıcı adı giriniz!</p>';
                        break;
                    case 'gecersizEposta':
                        echo '<p class="error">Geçerli bir e-posta giriniz!</p>';
                        break;
                    case 'gecersizKullaniciAdi':
                        echo '<p class="error">Geçerli bir kullanıcı adı giriniz!</p>';
                        break;
                    case 'sifreFarkli':
                        echo '<p class="error">Girdiğiniz şifreler farklı!</p>';
                        break;
                    case 'sqlHatasi':
                        echo '<p class="error">Veritabanında bir sorun oluştu!</p>';
                        break;
                    case 'kullaniciAdiMevcut':
                        echo '<p class="error">Farklı bir kullanıcı adı giriniz(kullanıcı adı veritabanında mevcut)!</p>';
                        break;
                }
            }
            else if (isset($_GET['success']))
            {
                if ($_GET['success'] == 'kayitBasarili') {
                    echo '<p class="success">Kurum kaydı başarı ile yapılmıştır.</p>';
                }
            }
        ?><div class="co">
        <div class="coc">
        <form action="../../includes/i_admin/i_anasayfa_admin/i_kurumlari_yonet/kurumEkle.inc.php" method="POST">
            ...
            <label for="svb_sifre_tekrar">Tekrar şifre</label>
